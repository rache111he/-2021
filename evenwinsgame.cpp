...
/* explanation: the ai takes 2 marbles until it is down to 5 or 4,
 where then AI will take 4 to take the obvious win. aside from 5
  or 4, as the ai only adds 2, an even number, there is no way it 
  loses. it is a very simple strategy but not fun for the player*/
void computer_turn() {
